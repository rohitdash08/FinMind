...
- Savings goals: CRUD `/savings`, contribute via `/savings/{id}/contribute`, milestone CRUD via `/savings/{id}/milestones`
...
- Savings page: create savings goals, add contributions, and track milestone progress to completion.
