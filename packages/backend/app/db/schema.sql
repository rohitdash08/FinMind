...
CREATE INDEX IF NOT EXISTS idx_login_events_ip ON login_events(user_id, ip_address);
...
CREATE INDEX IF NOT EXISTS idx_login_anomalies_user ON login_anomalies(user_id, created_at DESC);
