...
def cache_set(key: str, value, ttl_seconds: int | None = None):
    ...
    try:
        ...
        logger.exception("Cache set skipped because Redis is unavailable")
...
def cache_get(key: str):
    try:
        ...
        logger.exception("Cache get skipped because Redis is unavailable")
        return None
...
def cache_delete_patterns(patterns: Iterable[str]):
    try:
        ...
        logger.exception("Cache invalidation skipped because Redis is unavailable")
